...
<head>
    ...
    <title>Silver Happy | Modifier Profil Prestataire</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Modifier Profil Prestataire</h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-check-circle mr-1 text-emerald-400"></i> Statut validation
                                    </label>
                                    <div class="flex items-center gap-3">
                                        <span id="statut_validation_badge" class="text-xs font-bold px-3 py-2 rounded-lg border">—</span>
                                        <a href="../documents_pro/admin_view_documents_pro.php?id=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" 
                                ...
                                <div>
                                    ...
                                    <input type="number" id="commission" min="0" step="0.01" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div>
    ...
    <script src="../../js/admin/profile/edit_profile_pro.js?v=<?php echo time(); ?>"></script>
</body>
</html>