...
<head>
    ...
    <title>Silver Happy | Modifier Profil Admin</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Modifier Profil Admin</h3>
                    <a href="admin_profile_admin.php" class="text-sm font-normal italic text-gray-300 hover:text-white transition flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-user-shield mr-2 text-red-500"></i>Informations de l'admin
                            </h5>
                        </div>
                        <div class="p-6">
                            ...
                            <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                                <a href="admin_profile_admin.php" class="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold text-sm">Annuler</a>
    ...
    <script src="../../js/admin/profile/edit_profile_admin.js?v=<?php echo time(); ?>"></script>
</body>
</html>