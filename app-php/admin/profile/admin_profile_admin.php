...
<head>
    ...
    <title>Silver Happy | Profils Admins</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <main class="flex-1 bg-gray-50 mt-12 md:mt-0 pb-10">
            <header class="bg-gray-800 pt-3">
                <div class="bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow-md text-white flex justify-between items-center rounded-tl-3xl">
                    <h1 class="text-2xl font-bold uppercase tracking-wide">Profils Admins</h1>
                </div>
            </header>
            <section class="p-6">
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody id="profileAdminTableBody" class="divide-y divide-gray-100"></tbody>
                        </table>
                    </div>
                </div>
            </section>
    ...
    <script src="../../js/admin/profile/profile_admin.js?v=<?php echo time(); ?>"></script>
</body>
</html>