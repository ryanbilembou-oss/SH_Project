...
<head>
    ...
    <title>Silver Happy | Ajouter Entrée Planning</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Ajouter une Entrée Planning</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-calendar-check mr-2 text-lime-500"></i>Nouvelle entrée
                            </h5>
                        </div>
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="note_perso" rows="3" placeholder="Note du senior..." class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition resize-none"></textarea>
                            </div>
    ...
    <script src="../../js/admin/planning/create_planning_senior.js?v=<?php echo time(); ?>"></script>
</body>
</html>