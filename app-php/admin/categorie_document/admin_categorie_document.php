...
<head>
    ...
    <title>Silver Happy | Catégories Documents</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <main class="flex-1 bg-gray-50 mt-12 md:mt-0 pb-10">
            <header class="bg-gray-800 pt-3">
                <div class="bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow-md text-white flex justify-between items-center rounded-tl-3xl">
                    <h1 class="text-2xl font-bold uppercase tracking-wide">Catégories Documents</h1>
                    <a href="admin_create_categorie_document.php" class="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold py-2 px-4 rounded-lg transition-colors shadow-lg flex items-center gap-2">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-800 text-gray-100 uppercase text-xs tracking-wide">
                                    <th class="p-4 font-semibold">Nom catégorie</th>
                                    <th class="p-4 font-semibold">Type prestataire</th>
    ...
    <script src="../../js/admin/categorie_document/categorie_document.js?v=<?php echo time(); ?>"></script>
</body>
</html>