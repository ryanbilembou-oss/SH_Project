...
<head>
    ...
    <title>Silver Happy | Modifier Offre Prestataire</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Modifier une Offre</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-briefcase mr-2 text-yellow-500"></i>Modifier l'offre
                            </h5>
                        </div>
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="titre" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-1">Prix personnalisé (€)</label>
                                <input type="number" id="prix_personnalise" min="0" step="0.01" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                            </div>
                            <div>
    ...
    <script src="../../js/admin/offre_prestataire/edit_offre_prestataire.js?v=<?php echo time(); ?>"></script>
</body>
</html>