...
<head>
    ...
    <title>Silver Happy | Créer une Intervention</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Créer une Intervention</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-hand-holding-heart mr-2 text-cyan-500"></i>Informations de l'intervention
                            </h5>
                        </div>
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-briefcase mr-1 text-yellow-400"></i> Prestataire
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-user-clock mr-1 text-blue-400"></i> Senior
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-tasks mr-1 text-pink-400"></i> Service
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-flag mr-1 text-yellow-400"></i> Statut
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-calendar-alt mr-1 text-cyan-400"></i> Date début
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-calendar-check mr-1 text-cyan-400"></i> Date fin
                                    </label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-euro-sign mr-1 text-emerald-400"></i> Prix (€)
                                    </label>
                                    <input type="number" id="prix" min="0" step="0.01" placeholder="0.00" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-percent mr-1 text-gray-400"></i> Commission (€)
                                    </label>
                                    <input type="number" id="commission_montant" min="0" step="0.01" placeholder="0.00" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-map-marker-alt mr-1 text-red-400"></i> Lieu
                                    </label>
                                    <input type="text" id="lieu" placeholder="Adresse de l'intervention" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-bold text-gray-700 mb-1">
                                        <i class="fas fa-align-left mr-1 text-gray-400"></i> Description (optionnel)
                                    </label>
                                    <textarea id="bio_intervention" rows="3" placeholder="Description de l'intervention..." class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition resize-none"></textarea>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" id="est_medical" class="w-4 h-4 text-blue-600 rounded">
                                    <label class="text-sm font-bold text-gray-700">
                                        <i class="fas fa-heartbeat mr-1 text-red-400"></i> Intervention médicale
                                    </label>
                                </div>
                            </div>
    ...
    <script src="../../js/admin/intervention/create_intervention.js?v=<?php echo time(); ?>"></script>
</body>
</html>