...
<head>
    ...
    <title>Silver Happy | Gestion Articles</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <main class="flex-1 bg-gray-50 mt-12 md:mt-0 pb-10">
            ...
            <header class="bg-gray-800 pt-3">
                <div class="bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow-md text-white flex justify-between items-center rounded-tl-3xl">
                    <h1 class="text-2xl font-bold uppercase tracking-wide">Articles</h1>
                    <a href="admin_create_article.php" class="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold py-2 px-4 rounded-lg transition-colors shadow-lg flex items-center gap-2">
            ...
            <section class="p-6">
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="bg-gray-50 border-b border-gray-200 p-4 flex justify-between items-center">
                        <h2 class="font-bold text-gray-600 uppercase text-sm tracking-wider">Catalogue</h2>
                        <div class="relative">
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-900/70 backdrop-blur-sm hidden items-center justify-center z-50 opacity-0 transition-opacity duration-300" aria-modal="true" role="dialog">
        <div id="deleteModalContent" class="bg-white rounded-2xl p-8 max-w-sm w-full shadow-2xl transform scale-95 transition-transform duration-300">
            <div class="text-center">
                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-100 mb-4">
                    <i class="fas fa-exclamation-triangle text-red-600 text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-900">Supprimer l'article ?</h3>
                <p class="text-gray-500 mt-2 text-sm">Cette action est irréversible.</p>
            </div>
            <div class="flex flex-col gap-3 mt-8">
                <button id="confirmDeleteBtn" type="button" class="w-full py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-semibold flex justify-center items-center gap-2">
                    Confirmer la suppression
                </button>
                <button id="cancelDeleteBtn" type="button" class="w-full py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold">
                    Annuler
                </button>
            </div>
        </div>
    ...
    <script src="../../js/admin/article/articles.js"></script>
    <script src="../../js/admin/article/delete_article.js"></script>
</body>
</html>