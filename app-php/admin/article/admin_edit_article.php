...
<head>
    ...
    <title>Silver Happy | Modifier un Article</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
                    ...
                    <div class="bg-white border-transparent rounded-xl shadow-2xl overflow-hidden border border-gray-200">
                        ...
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-edit mr-2 text-blue-500"></i>Informations de l'article
                            </h5>
                        </div>
    ...
    <script src="../../js/admin/article/edit_article.js"></script>
</body>
</html>