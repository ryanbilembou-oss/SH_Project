...
<head>
    ...
    <title>Silver Happy | Catégories Articles</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal overflow-x-hidden">
        ...
        <main class="flex-1 bg-gray-50 mt-12 md:mt-0 pb-10">
            <header class="bg-gray-800 pt-3">
                <div class="bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow-md text-white flex justify-between items-center rounded-tl-3xl">
                    <h1 class="text-2xl font-bold uppercase tracking-wide">Catégories Articles</h1>
                    <a href="admin_create_categorie_article.php" class="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold py-2 px-4 rounded-lg transition-colors shadow-lg flex items-center gap-2">
    ...
    <script src="../../../js/admin/article/categorie_article/categorie_article.js"></script>
</body>
</html>