...
<head>
    ...
    <title>Silver Happy | Créer une catégorie article</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Nouvelle Catégorie Article</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-2xl p-8">
                        <form id="createCategorieForm" class="space-y-6">
                            <div>
                                ...
                                <input type="text" id="nom_categorie" required placeholder="Ex: Actualité, Santé..."
    ...
    <script src="../../../js/admin/article/categorie_article/create_categorie_article.js"></script>
</body>
</html>