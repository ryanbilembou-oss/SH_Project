...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
                ...
                <div class="w-full max-w-4xl">
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200 p-8">
                        <form id="createFullUserForm" class="space-y-8">
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-gray-700 border-b pb-2 mb-4">
                                    <i class="fas fa-lock text-blue-500 mr-2"></i> 1. Identifiants de connexion
                                </h4>
                            ...
                            <div id="profileSection" class="hidden space-y-6">
                                <h4 class="text-lg font-bold text-gray-700 border-b pb-2">
                                    <i class="fas fa-id-card text-blue-500 mr-2"></i> 2. Informations du Profil
                                </h4>
                                ...
                                <div id="fieldDateNaissance" class="hidden">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                ...
                                <div id="fieldsSenior" class="hidden">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                ...
                                <div id="fieldsPro" class="hidden space-y-6">
                                    
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">
                                            <i class="fas fa-tag mr-1 text-blue-400"></i> Type de prestataire *
                                        </label>
                                        <select id="id_type" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white">
                                            <option value="">Chargement...</option>
                                        </select>
                                        <p class="text-xs text-gray-400 mt-1">Détermine les documents obligatoires à fournir</p>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="siret" maxlength="14" class="w-full px-4 py-2 border rounded-lg">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" id="adresse_pro" class="w-full px-4 py-2 border rounded-lg">
                                        </div>
                                        <div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <textarea id="bio" rows="3" class="w-full px-4 py-2 border rounded-lg resize-none"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../js/admin/create_users.js?v=<?php echo time(); ?>"></script>
</body>
</html>