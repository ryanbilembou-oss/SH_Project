...
<head>
    ...
    <title>Silver Happy | Devis</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <main class="flex-1 bg-gray-50 mt-12 md:mt-0 pb-10">
            <header class="bg-gray-800 pt-3">
                <div class="bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow-md text-white flex justify-between items-center rounded-tl-3xl">
                    <h1 class="text-2xl font-bold uppercase tracking-wide">Devis</h1>
                    <a href="admin_create_devis.php" class="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold py-2 px-4 rounded-lg transition-colors shadow-lg flex items-center gap-2">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-800 text-gray-100 uppercase text-xs tracking-wide">
                                    ...
                                    <th class="p-4 font-semibold">Senior</th>
                                    <th class="p-4 font-semibold">Service</th>
                                    <th class="p-4 font-semibold text-center">Montant TTC</th>
                                    <th class="p-4 font-semibold text-center">Date validité</th>
                                    <th class="p-4 font-semibold text-center">Statut</th>
                                    <th class="p-4 font-semibold text-center">Actions</th>
                                </tr>
                            </thead>
                            <tbody id="devisTableBody" class="divide-y divide-gray-100"></tbody>
                        </table>
                    </div>
                </div>
            </section>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-900/70 backdrop-blur-sm hidden items-center justify-center z-50 opacity-0 transition-opacity duration-300">
        <div class="bg-white rounded-2xl p-8 max-w-sm w-full shadow-2xl">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900">Supprimer le devis ?</h3>
    ...
    <script src="../../js/admin/devis/devis.js?v=<?php echo time(); ?>"></script>
</body>
</html>