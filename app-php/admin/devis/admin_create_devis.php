...
<head>
    ...
    <title>Silver Happy | Créer un Devis</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Créer un Devis</h3>
                    <a href="admin_devis.php" class="text-sm font-normal italic text-gray-300 hover:text-white transition flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-file-alt mr-2 text-yellow-500"></i>Informations du devis
                            </h5>
                        </div>
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1"><i class="fas fa-file-invoice mr-1 text-gray-400"></i> Montant HT (€)</label>
                                    <input type="number" id="montant_ht" min="0" step="0.01" placeholder="0.00" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1"><i class="fas fa-file-invoice-dollar mr-1 text-emerald-400"></i> Montant TTC (€)</label>
                                    <input type="number" id="montant_ttc" min="0" step="0.01" placeholder="0.00" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1"><i class="fas fa-percent mr-1 text-gray-400"></i> Taux commission (%)</label>
                                    <input type="number" id="taux_commission" min="0" step="0.01" value="15" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-1"><i class="fas fa-calendar mr-1 text-cyan-400"></i> Date de validité</label>
                                    <input type="date" id="date_validite" class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                                </div>
                            </div>
                            <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                                <a href="admin_devis.php" class="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold text-sm">Annuler</a>
    ...
    <script src="../../js/admin/devis/create_devis.js?v=<?php echo time(); ?>"></script>
</body>
</html>