...
<head>
    ...
    <title>Silver Happy | Modifier Catégorie Service</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Modifier une Catégorie Service</h3>
                    <a href="admin_categorie_service.php" class="text-sm font-normal italic text-gray-300 hover:text-white transition flex items-center gap-2">
                    ...
                    <div class="bg-white border-transparent rounded-xl shadow-2xl overflow-hidden border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-tags mr-2 text-purple-500"></i>Modifier la catégorie
                            </h5>
                        </div>
                        <div class="p-6">
                            <div>
                                ...
                                <input type="text" id="nom_categorie" placeholder="Nom de la catégorie"
                            ...
                            <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                                <a href="admin_categorie_service.php" class="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold text-sm">Annuler</a>
    ...
    <script src="../../../js/admin/service/edit_categorie_service.js?v=<?php echo time(); ?>"></script>
</body>
</html>