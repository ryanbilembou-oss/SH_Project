...
<head>
    ...
    <title>Silver Happy | Créer Type Prestataire</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-6 shadow text-2xl text-white flex justify-between items-center">
                    <h3 class="font-bold pl-2 uppercase tracking-wide">Créer un Type Prestataire</h3>
                    <a href="admin_type_prestataire.php" class="text-sm font-normal italic text-gray-300 hover:text-white transition flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-xl shadow-2xl border border-gray-200">
                        <div class="bg-gray-50 border-b border-gray-200 p-4">
                            <h5 class="font-bold uppercase text-gray-600 italic">
                                <i class="fas fa-tag mr-2 text-blue-500"></i>Nouveau type
                            </h5>
                        </div>
                        <div class="p-6 space-y-6">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-1">Nom du type</label>
                                <input type="text" id="nom_type" placeholder="Ex: Médecin, Infirmier..." class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition">
                            </div>
                            <div class="flex justify-end gap-3 pt-6 border-t border-gray-100">
                                <a href="admin_type_prestataire.php" class="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold text-sm">Annuler</a>
    ...
    <script src="../../js/admin/type_prestataire/create_type_prestataire.js?v=<?php echo time(); ?>"></script>
</body>
</html>