...
<body class="bg-[#FFFFF6] min-h-screen" id="tab-bord-page">

    
    <?php include('../include/navbar.php'); ?>

    <main class="container mx-auto max-w-6xl px-4 py-10" id="tab-bord-main">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            <div class="group bg-white p-8 rounded-[40px] border-2 border-transparent hover:border-[#7CABD3] hover:shadow-xl transition-all duration-500 text-center cursor-pointer">
                ...
                <p class="text-4xl font-fira text-[#1A2B49]" id="nbEvenements">—</p>
                <p class="text-sm text-gray-400 uppercase font-fira tracking-widest mt-1">Événements</p>
            </div>
            <div class="group bg-white p-8 rounded-[40px] border-2 border-transparent hover:border-[#FCE297] hover:shadow-xl transition-all duration-500 text-center cursor-pointer">
                ...
                <p class="text-4xl font-fira text-[#1A2B49]" id="nbServices">—</p>
                <p class="text-sm text-gray-400 uppercase font-fira tracking-widest mt-1">Services</p>
            </div>
            <div class="group bg-white p-8 rounded-[40px] border-2 border-transparent hover:border-[#7CABD3] hover:shadow-xl transition-all duration-500 text-center cursor-pointer">
            ...
            <div class="group bg-white p-8 rounded-[40px] border-2 border-transparent hover:border-[#FCE297] hover:shadow-xl transition-all duration-500 text-center cursor-pointer">
                ...
                <p class="text-4xl font-fira text-[#1A2B49]" id="nbFactures">—</p>
                <p class="text-sm text-gray-400 uppercase font-fira tracking-widest mt-1">Factures</p>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            <div class="md:col-span-2">
                ...
                <div class="flex justify-center mt-6">
                    <a href="/users/seniors/planning.php" class="bg-[#7CABD3] text-white px-8 py-3 rounded-full shadow hover:text-[#7CABD3] hover:bg-white border-2 border-[#7CABD3] transition-all duration-300 font-fira text-base">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <a href="/users/seniors/evenements.php" class="group bg-white p-5 rounded-[30px] border-2 border-transparent hover:border-[#7CABD3] hover:shadow-lg transition-all duration-300 flex items-center gap-4">
                        ...
                        <span class="font-fira uppercase text-[#1A2B49] text-base">Réserver un événement</span>
                    </a>
                    <a href="/users/seniors/services.php" class="group bg-white p-5 rounded-[30px] border-2 border-transparent hover:border-[#FCE297] hover:shadow-lg transition-all duration-300 flex items-center gap-4">
                        ...
                        <span class="font-fira uppercase text-[#1A2B49] text-base">Demander un service</span>
                    </a>
                    ...
                    <a href="/users/seniors/conseils.php" class="group bg-white p-5 rounded-[30px] border-2 border-transparent hover:border-[#FCE297] hover:shadow-lg transition-all duration-300 flex items-center gap-4">
                        ...
                        <span class="font-fira uppercase text-[#1A2B49] text-base">Espace conseils</span>
                    </a>
                    <a href="/users/seniors/boutique.php" class="group bg-white p-5 rounded-[30px] border-2 border-transparent hover:border-[#7CABD3] hover:shadow-lg transition-all duration-300 flex items-center gap-4">
                        ...
                        <span class="font-fira uppercase text-[#1A2B49] text-base">Accéder à la boutique</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <section class="pb-16 relative">
            ...
            <div class="flex justify-center mt-10">
                <a href="/users/seniors/evenements.php" class="bg-[#7CABD3] text-white px-8 py-3 rounded-full shadow hover:text-[#7CABD3] hover:bg-white border-2 border-[#7CABD3] transition-all duration-300 font-fira text-base">
