    ...
    <nav class="bg-white px-6 pt-4 shadow-sm border-b-2 border-[#FCE297] sticky top-0 z-50">
        <div class="container mx-auto flex flex-col gap-4">
            ...
            <div class="flex pb-4 gap-8 mx-auto justify-center flex-wrap text-base">
                ...
                <a href="/users/seniors/evenements.php" class="flex items-center gap-2 font-bold pb-2 border-b-2 border-[#FCE297] text-[#7CABD3]">
  ...
  <div id="modalInscription" class="fixed inset-0 bg-[#1A2B49]/70 backdrop-blur-sm hidden items-center justify-center z-50 opacity-0 transition-opacity duration-300">
      <div class="bg-white rounded-[40px] p-10 max-w-md w-full shadow-2xl mx-4">
          <div class="text-center mb-6">
              ...
              <h3 class="text-2xl font-black uppercase tracking-tighter text-[#1A2B49]" id="modalTitre"></h3>
              <p class="text-gray-400 mt-2 text-base" id="modalDetails"></p>
              <p class="text-2xl font-black text-[#1A2B49] mt-3" id="modalPrix"></p>
          </div>
          <div class="flex flex-col gap-3 mt-8">
              <button id="btnGratuit" class="w-full py-4 bg-[#7CABD3] text-white rounded-2xl hover:bg-[#1A2B49] transition font-black uppercase tracking-widest text-sm">
                  Confirmer la réservation
              </button>
              <button id="cancelInscription" class="w-full py-4 bg-gray-100 text-gray-700 rounded-2xl hover:bg-gray-200 transition font-black uppercase tracking-widest text-sm">
                  Annuler
              </button>
          </div>
      </div>
    ...
    <div id="modalAnnulation" class="fixed inset-0 bg-[#1A2B49]/70 backdrop-blur-sm hidden items-center justify-center z-50 opacity-0 transition-opacity duration-300">
        <div class="bg-white rounded-[40px] p-10 max-w-md w-full shadow-2xl mx-4">
            <div class="text-center mb-6">
                ...
                <h3 class="text-2xl font-black uppercase tracking-tighter text-[#1A2B49]">Annuler la réservation ?</h3>
                <p class="text-gray-400 mt-2 text-base">Cette action est irréversible.</p>
            </div>
            <div class="flex flex-col gap-3 mt-8">
                <button id="btnConfirmerAnnulation" class="w-full py-4 bg-red-500 text-white rounded-2xl hover:bg-red-700 transition font-black uppercase tracking-widest text-sm">
                    Confirmer l'annulation
                </button>
                <button id="btnCancelAnnulation" class="w-full py-4 bg-gray-100 text-gray-700 rounded-2xl hover:bg-gray-200 transition font-black uppercase tracking-widest text-sm">
                    Retour
                </button>
            </div>
        </div>
