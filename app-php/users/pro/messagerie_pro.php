...
<body class="bg-[#FFFFF6] min-h-screen">
    ...
    <main class="container mx-auto max-w-5xl px-4 py-10">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-400 mt-1 text-lg">Échangez avec vos clients seniors.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">

            <div class="bg-white rounded-[40px] border-2 border-transparent hover:border-[#7CABD3] transition-all p-4">
                <p class="font-fira uppercase text-xs tracking-widest text-gray-400 mb-4 px-2">Mes clients</p>
            ...
            <div class="md:col-span-2 bg-white rounded-[40px] border-2 border-transparent hover:border-[#7CABD3] transition-all flex flex-col" style="min-height:580px;">
                ...
                <div id="convHeader" class="p-6 border-b border-gray-100 flex items-center gap-4">
                    <div class="w-12 h-12 bg-[#FCE297]/30 rounded-full flex items-center justify-center">
                        <iconify-icon icon="mdi:account" class="text-2xl text-[#1A2B49]"></iconify-icon>
                    </div>
                    <div>
                        <p class="font-fira text-[#1A2B49] text-lg" id="convNom">Sélectionnez un client</p>
                ...
                <div id="messagesContainer" class="flex-1 p-6 space-y-3">
                    <div class="flex items-center justify-center h-full">
                        <div class="text-center text-gray-300">
                            ...
                            <p class="font-fira uppercase text-sm tracking-widest">Choisissez un client</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="zoneEnvoi" class="hidden p-4 border-t border-gray-100">
                    <div class="flex gap-3">
                        ...
                        <button onclick="envoyerMessage()"
                            class="w-12 h-12 bg-[#1A2B49] text-white rounded-full flex items-center justify-center hover:bg-[#7CABD3] transition-all flex-shrink-0">
    ...
    <script src="/js/users/pro/messagerie_pro.js?v=<?php echo time(); ?>"></script>
