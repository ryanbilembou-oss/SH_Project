      ...
      <div class="container mx-auto flex flex-col gap-4">
        <div class="flex justify-between items-center w-full">
          ...
          <div class="flex items-center space-x-6 group">
            ...
            <a href="users/register.php" class="text-[#7CABD3] border-2 border-transparent px-6 py-2 rounded-full font-bold uppercase text-xs transition-all duration-300 hover:bg-[#7CABD3] hover:text-white hover:shadow-md">
              Inscription
            </a>
          </div>
        </div>
