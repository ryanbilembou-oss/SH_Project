      ...
      (cat) => `
        <tr id="row-${cat.id_categorie}" class="hover:bg-gray-50 transition-colors">
            ...
            <td class="p-4 text-center">
                <a href="admin_edit_categorie_article.php?id=${cat.id_categorie}" class="inline-flex items-center gap-1 bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1 rounded-lg text-xs font-semibold transition mr-1">
  ...
  .addEventListener("click", async () => {
    try {
      const res = await fetch(
        `${API_BASE}/admin/article/categorie_article/delete`,
        {
          method: "DELETE",
